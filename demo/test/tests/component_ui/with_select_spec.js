...
describeMixin('app/component_ui/with_select', function () {
  ...
  it('removes unselected item from the selectionItem cache', function () {
    var $unselectedElem = $('#mail_2139');
    this.component.attr.selectedIds = ['#mail_2139']
  ...
  it('adds selected items to selectedIds when initializeSelections called', function() {
    $('#mail_2139').addClass(this.component.attr.selectedClass);
    $('#mail_2143').addClass(this.component.attr.selectedClass);
    this.component.initializeSelections();
    expect(this.component.getSelectedIds()).toEqual(['mail_2139', 'mail_2143']);
  });
