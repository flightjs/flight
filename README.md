...
**Note**: work is currently ongoing for Flight v2 and beyond, which will make some backward incompatible changes. To see the latest v1.x code and documentation, check out [the branch](https://github.com/flightjs/flight/tree/v1.x).
